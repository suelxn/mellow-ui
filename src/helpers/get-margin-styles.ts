/*
  Gera o `className` e as CSS custom properties de margem (m, mx, my, mt, mr, mb, ml) a partir
  das props de margem de um componente, usando `getResponsiveStyles` como base.
*/
