/*
  Ponto único de exportação dos helpers internos do Design System: utilitários de resolução de
  props, geração de classes/estilos responsivos, cores, tipos e pequenas funções de apoio
