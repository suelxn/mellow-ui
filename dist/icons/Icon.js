...
export function Icon({ name, size = 'md', // Define 'md' (24px) como padrão do Design System
color = 'currentColor', weight = 'regular', ...props }) {
    ...
    return (_jsx(IconComponent, { size: computedSize, color: color, weight: weight, ...props }));
}
